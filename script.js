...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const slides = [
        ...
        {
            title: "Empowering Skills<br><span>Shaping Future</span><br>Ethical Placements",
...
// ==========================================================================
// 10. Certificates Slider Control
// ==========================================================================
window.slideCert = (direction) => {
    const slider = document.getElementById('cert-slider');
    if (!slider) return;
    
    // Get the width of one slide, including the gap
    const firstSlide = slider.querySelector('.certificate-slide');
    if (!firstSlide) return;
    
    // Get the computed gap from the slider parent
    const sliderStyles = window.getComputedStyle(slider);
    const gap = parseFloat(sliderStyles.gap) || 0;
    
    // Calculate the amount to scroll based on the visible width of one item + gap
...
// ==========================================================================
// 11. Industries Slider Control
// ==========================================================================
window.slideIndustries = (direction) => {
    const slider = document.getElementById('industries-slider');
    if (!slider) return;

    const firstCard = slider.querySelector('.industry-card');
    if (!firstCard) return;
